				...
				<div class="row">
					...
					<div class="col-sm-9">
						<div class="beta-products-list">
							...
							<div class="pager"> {{$products_list->links("pagination::bootstrap-4")}}</div>
						...
						<div class="beta-products-list">
							...
							<div class="row">
								@foreach ($products_list_km as $product_km)
								<div class="col-sm-4">
									<div class="single-item">
							...
							<div class="pager"> {{$products_list_km->links("pagination::bootstrap-4")}}</div>
