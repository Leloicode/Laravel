                ...
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                  ...
                                  <select class="form-control" name="id_type" id="">
                                    ...
                                    <option @if ($type->id == $product->id_type)
                                        selected
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" max="100" value="{{$product->name}}" name="name" placeholder="Bánh Kem Halovi"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="number" min="1" value="{{$product->unit_price}}" name="unit_price" placeholder="Giá gốc"
                                    class="form-control ps-0 form-control-line" required>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="number" min="0" value="{{$product->promotion_price}}" name="promotion_price" placeholder="Giá khuyến mãi"
                                    class="form-control ps-0 form-control-line" required>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text"  value="{{$product->unit}}" name="unit" placeholder="Đơn vị vd: cái,hộp.."
                                    class="form-control ps-0 form-control-line" required>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <textarea class="form-control" name="des" rows="5" id="comment">{{$product->description}} </textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="file" name="img" onchange="Changeimg(event)"
                                    ...
                                    <img width="100" src="/image/product/{{$product->image}}" id="imgg" alt=""><br>
