                ...
                <div class="card">
                    <div class="card-body">
                        @if (session('success'))
                                ...
                                @endif
                        <h4 class="card-title">Danh sách sản phấm</h4>
                        ...
                        <div class="table-responsive">
                            <table class="table user-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="border-top-0">Promotion_price</th>
                                        ...
                                        <div class="modal-dialog" role="document">
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                              <b style="color: red;">Bạn chắc chắn muốn xóa #{{$product->id}} ?</b>
                            ...
                            <div class="pager" style="display: flex;justify-content: space-between;"><div class="page">{{$products->Links()}}</div><div class="them"><a href="{{ route('product.create') }}"><button type="button" style="" class="btn btn-primary">Thêm sản phẩm</button></a></div> </div>
